    ...
    const experience = [
        {
            ...
            year: "2023 - 2025",
            description: [
                "Built a full-stack performance-tracking platform for global Medical Affairs teams using React, Node.js, and Express.",
                "Automated Python-based reporting pipelines, integrated RESTful APIs, and optimized backend SQL queries.",
                "Partnered with cross-functional teams to define KPIs and build Power BI dashboards for monitoring.",
                "Onboarded junior analysts through hands-on technical guidance and workflow alignment.",
            ],
        ...
        },
        {
            ...
            year: "Jan - Dec 2022",
            description: [
                "Researched and fine-tuned deep learning models for reflection removal in images, improving image quality metrics such as PSNR and SSIM.",
                "Curated a large-scale RAW image dataset for training and validation, and synthesized insights from 10+ academic papers to establish high-performing baselines for model development.",
            ],
        ...
        },
        {
            ...
            year: "Jan - Dec 2021",
            description: [
                "Launched the company's first production website using React on AWS",
                "Designed wireframes and prototypes for mobile app interfaces in Figma and Adobe XD.",
            ],
            skills: [
                "HTML",
                "CSS",
